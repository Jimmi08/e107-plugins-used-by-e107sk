	...
	public function config()
	{
		...
		$config['metatag_default'] = array(
			...
			'token'   => array(
				...
				'site:tagline'               => array(
					'help'    => "Site tagline",
					'handler' => 'metatag_global_token_site_tagline',
					'file'    => '{e_PLUGIN}metatag/includes/metatag.global.php',
				),
				...
				'site:keywords'        => array(
					'help'    => LAN_PLUGIN_METATAG_TOKEN_73,
					'handler' => 'metatag_global_token_site_keywords',
					'file'    => '{e_PLUGIN}metatag/includes/metatag.global.php',
				),
				'site:image'        => array(
					'help'    => 'Site button',
					'handler' => 'metatag_global_token_site_image',
					'file'    => '{e_PLUGIN}metatag/includes/metatag.global.php',
				),
