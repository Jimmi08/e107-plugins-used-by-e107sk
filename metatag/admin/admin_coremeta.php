...
$text = "
	<form method='post' action='".e_REQUEST_URL."' id='dataform'>
		<fieldset id='core-meta-settings'>
			...
			<table class='table adminform'>
				...
				<tbody>
					<tr>
						<td>".LAN_DESCRIPTION."<br> Used in token <code>{site:description}</code>  </td>
						<td>";
					...
					<tr>
						<td>".LAN_KEYWORDS."<br> Used in token <code>{site:keywords}</code>  </td>
						<td>";
