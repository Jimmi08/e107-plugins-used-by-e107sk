...
// Put up a prompt to get the view period
  require_once(HEADERF);
	...
	<form method='post' action='".e_SELF."' class='form-inline'>
	...
	{  // Offer choice of templates
	  ...
	  <td class='forumheader3' style='text_align:center'><select name='template_choice' class='tbox form-control' style='width:140px;' >\n";
	...
	<td class='forumheader3' style='text_align:center'>";
	$cal_text .= "
	<input type='radio' name='output_type' class='tbox form-control' value='display' checked='checked' /> ".EC_LAN_159." 
	<input type='radio' name='output_type' class='tbox form-control' value='print' /> ".EC_LAN_160."<br />";
	if ($ec_enable_pdf)
	{
	  $cal_text .= "<input type='radio' class='tbox '  name='output_type' value='pdf' /> ".EC_LAN_161;
	}
	$cal_text .="</td></tr>";
	
	$cal_text .= "<tr><td colspan='2'  style='text-align:center' class='fcaption'><input class='btn btn-primary button' type='submit' name='set_dates' value='".EC_LAN_156."' /></td></tr>";
...
{
	$text = "<select name='".($drop_type ? 'end_date' : 'start_date')."' class='tbox form-control' style='width:140px;' >\n";
	if ($drop_type)
	{
