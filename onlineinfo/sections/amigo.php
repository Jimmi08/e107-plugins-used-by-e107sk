...
$friendonline=0;
		...
		$sql2->gen($query);
			...
			if ($row3 = $sql3 -> fetch()){$friendonline++;}
} 

if ($friendonline!=0){$friendtext="<img src='".e_PLUGIN_ABS."onlineinfo/images/fonline.gif' style='vertical-align:middle; border:0;'  alt='".AMIGO_22."' />";}
	...
	{
		if (!$sql -> delect("onlineinfo_friends", "*", "amigo_user='".USERID."' AND amigo_amigo='".$_POST['buddy']."'"))
		{
	...
	// To create a list of users to choose
		...
		$sql2->db_Select_gen($query);
			...
			<a href='".e_PLUGIN."pm/pm.php?send.$user_id'><img src='".e_PLUGIN_ABS."onlineinfo/images/icon_pm.png' height='16px' alt='".AMIGO_16."' title='".AMIGO_16."' border='0' id='im' /></a>&nbsp;
			<a href='".e_REQUEST_URL."?remove=$user_id'><img src='".e_PLUGIN_ABS."onlineinfo/images/delete.png' alt='".AMIGO_17."' title='".AMIGO_17."' border='0' id='im' /></a><br />";
