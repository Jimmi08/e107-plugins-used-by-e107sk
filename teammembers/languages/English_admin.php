...
+ ----------------------------------------------------------------------------+
|    e107 website system - 
|    L = LAN, P = PLUGIN, LAN_JM_- custom, LAN_ = core lan, 
+----------------------------------------------------------------------------+
*/
...
/* twins in global */
defined("LP_TEAMMEMBERS_NAME") 	 ? null : define("LP_TEAMMEMBERS_NAME", "Teammembers");
...
define("LP_TM_TAB_SOCIAL_LINKS", "Social Links");
define("LP_TM_TAB_PERSONAL_INFO", "Personal Info / Member page");
define("LP_TM_TAB_AWARDS", "Awards / Certificates");

define("LP_TM_MEMBER_NAME", "Full name");
define("LP_TM_USER_NAME", "User account [if available]");
define("LP_TM_POSITION", "Position");
define("LP_TM_PHONE_NUMBER", "Phone");
