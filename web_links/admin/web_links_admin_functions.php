...
function AdminHeader()
{
    ...
    $numrows = $row['numrows'];
    $content1 = "<span >" . _THEREARE . " <b>" . $numrows . "</b> " . _LINKSINDB . "</span> ";

    $result = e107::getDb()->retrieve("SELECT COUNT(*) AS numrows FROM #" . UN_TABLENAME_LINKS_CATEGORIES);
    $numrows = $result['numrows'];
    $content2 = "<span >" . _THEREARE . " <b>" . $numrows . "</b> " . _LINKSCATINDB . "</span> ";
...
function LinksModLink($lid)
{
    ...
    foreach ($result as $row) {
        ...
        if ($totalcomments == 0) {
            $content .= "<tr><td colspan=\"7\"><div class='center'><span color=\"#cccccc\">" . _WEBLINKCOMMENTNOCOM . "<br></span></div></td></tr>";
        }
        ...
        if ($totalvotes == 0) {
            $content .= "<tr><td colspan=\"7\"><div class='center'><span color=\"#cccccc\">" . _WEBLINKVOTEREGVOTES . "<br></span></div></td></tr>";
        }
        ...
        if ($totalvotes == 0) {
            $content .= "<tr><td colspan=\"7\"><div class='center'><span color=\"#cccccc\">" . _WEBLINKVOTEUNREGVOTES . "<br></span></div></td></tr>";
        }
        ...
        if ($totalvotes == 0) {
            $content .= "<tr><td colspan=\"7\"><div class='center'><span color=\"#cccccc\">" . _WEBLINKVOTEOUTVOTES . " " . $sitename . "<br></span></div></td></tr>";
        }
