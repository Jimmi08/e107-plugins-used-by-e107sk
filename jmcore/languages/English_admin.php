...
define("LAN_JM_CORE_ONEPAGE_LAN_04", "Exclude on: ");
define("LAN_JM_CORE_ONEPAGE_LAN_05", "You can exclude full or partial URLs using * as a wildcard. <br> For example: 
							www.site.com/contact.php will exclude only that single URL.<br>
							www.site.com/contact* will exclude contact.php and contact/ too.");
