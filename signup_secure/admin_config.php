...
class signup_secure_ui extends e_admin_ui
{
	...
	//	protected $preftabs        = array('General', 'Other' );
		...
		{
			$caption = LAN_HELP;
			$text =  'You can find more info on <a href="https://www.e107.sk/" target="_blank">www.e107.sk</a> 
			<br> You can support next development by visiting this site with AdBlock Off via Chrome. Thank you.
			<br> Any donation is welcomed too. ';
